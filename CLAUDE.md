...
| Plan | Descripción |
|------|------------|
| `starter` | Hasta 150 miembros, módulos básicos |
| `pro` | Hasta 500 miembros, IA incluida |
| `elite` | Ilimitado, todo incluido |
| `enterprise` | Multi-sede, white-label, SLA dedicado |
...
*GymApp — App Integral de Gimnasio de Élite*
